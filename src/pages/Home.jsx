...
const Home = () => {
  ...
  return (
    <section className="dark:bg-gray-100 dark:text-gray-800">
      <div className="container max-w-7xl p-6 mx-auto space-y-6 sm:space-y-12 border ">
        ...
        <div className="border flex bg-[#1313130D] rounded-3xl">
          ...
          >
            <div className="lg:p-20 space-y-2 lg:col-span-7 border justify-center items-center py-8">
              ...
              <NavLink className=""><button className="btn btn-primary">View The List</button></NavLink>{" "}
            </div>
            <img
              src={books[0].image}
              alt=""
