const Feedback = () => {
  return (
    <div className="container mx-auto lg:px-20 lg:py-8 lg:flex justify-around space-y-8">
      {/* YOUR OPENION */}
      <div className="flex flex-col p-8 shadow-sm rounded-xl lg:p-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
      ...
      <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-wrap items-center mt-2 mb-1 space-x-2">
            <div className="flex">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  className="w-6 h-6 text-yellow-500 dark:text-yellow-700"
                >
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                </svg>
              </button>
            ...
            <span className="text-gray-400 dark:text-gray-600">3 out of 5</span>
          </div>
          ...
          <div className="flex flex-col mt-4">
            <div className="flex items-center space-x-1">
              ...
              <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700 dark:bg-gray-300">
                <div className="bg-orange-700 dark:bg-orange-500 h-4 w-5/6"></div>
              </div>
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700 dark:bg-gray-300">
                <div className="bg-orange-700 dark:bg-orange-500 h-4 w-4/6"></div>
              </div>
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700 dark:bg-gray-300">
                <div className="bg-orange-700 dark:bg-orange-500 h-4 w-3/6"></div>
              </div>
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700 dark:bg-gray-300">
                <div className="bg-orange-700 dark:bg-orange-500 h-4 w-2/6"></div>
              </div>
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="flex-1 h-4 overflow-hidden rounded-sm bg-gray-700 dark:bg-gray-300">
                <div className="bg-orange-700 dark:bg-orange-500 h-4 w-1/6"></div>
              </div>
